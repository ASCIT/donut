...
def get_members_list():
    ...
    filterable_attrs = ["uid", "last_name", "first_name", "middle_name",
            "email", "entry_year", "graduation_year", "zip"]
...
def get_organizations_list():
    ...
    return json.dumps(helpers.get_organization_list_data(fields=fields, attrs=attrs))
